...
public class MacaroonPluginConfig {
     ...
     */
    public static final String MACAROON_TOKEN_PREFIX = "plugins.macaroons.token.prefix";

    /**
     * String
     * Sometimes, it is useful, for macaroons shared on multiples services, to be able to prefix caveat, this is the prefix value
     */
    public static final String MACAROON_WARP_CAVEAT_PREFIX = "plugins.macaroons.warpcaveatprefix";
     ...
     */
    public static final String MACAROON_VALID_CAVEAT_REGEXP = "plugins.macaroons.validcaveats.regexps";
